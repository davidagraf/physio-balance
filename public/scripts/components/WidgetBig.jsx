  ...
  render() {
    return (
      <div className="widgetbig">
        ...
        tincidunt. Aenean porta, nunc non finibus viverra, mauris nunc gravida ante, malesuada porttitor augue sapien
        sed leo.

        Praesent mollis libero sed sodales dapibus. Nullam molestie, risus nec pellentesque placerat, magna metus
        suscipit lectus, id vulputate neque neque et metus. Integer non suscipit sem, nec sodales nisi. Aliquam aliquam
        rutrum euismod. Nullam porttitor accumsan metus, in porta lacus tristique vitae. Ut at nulla lacinia, placerat
        nibh id, suscipit leo. Proin elit leo, fringilla eu nisi sit amet, tempor vehicula diam. Mauris erat lacus,
